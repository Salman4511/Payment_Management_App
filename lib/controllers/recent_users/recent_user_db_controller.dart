...
class RecentUserDatabaseController extends GetxController {
  ...
  final List<RecentUserPaymentModel> initialRecentUsers = [
    RecentUserPaymentModel(
      ...
      secondName: 'Chimbo',
      profilePicture:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRscCytvWC2M6bqUR5EtpzVmDbVbPrAtlA2FrNDuUHgsg&s',
    ),
    RecentUserPaymentModel(
      id: 2,
      name: 'Gail',
      secondName: 'Monnet',
      profilePicture:
          'https://images.unsplash.com/photo-1480455624313-e29b44bbfde1?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bWFsZSUyMHByb2ZpbGV8ZW58MHx8MHx8fDA%3D',
    ),
    RecentUserPaymentModel(
      id: 2,
      name: 'Venessa',
    ...
    RecentUserPaymentModel(
      ...
      secondName: 'Rathbun',
      profilePicture:
          'https://img.freepik.com/free-photo/portrait-man-having-great-time_23-2149443790.jpg?size=626&ext=jpg&ga=GA1.1.553209589.1714348800&semt=ais',
    ),
    RecentUserPaymentModel(
      id: 2,
      name: 'Roshel',
      secondName: 'Deshong',
      profilePicture:
          'https://media.istockphoto.com/id/1346530154/photo/profile-of-thoughtful-young-businessman-looking-down.jpg?s=612x612&w=0&k=20&c=2fiXHRlCH0msjzWyqjP8J5LK8ABhxSzYvIRcw6hgHN0=',
    ),
    RecentUserPaymentModel(
      id: 2,
      name: 'Alice',
    ...
    RecentUserPaymentModel(
      ...
      secondName: 'maechel',
      profilePicture:
          'https://i.pinimg.com/236x/86/e0/c7/86e0c7cf8cd0e96df1e5b66749790715.jpg',
    ),
    RecentUserPaymentModel(
      id: 2,
      name: 'Alice',
      secondName: 'Smith',
      profilePicture:
          'https://st3.depositphotos.com/4071389/14851/i/450/depositphotos_148514169-stock-photo-handsome-shirtless-man.jpg',
    ),
  ];
}
